...
public class exercicios06a09 {
	...
	//----Chamada de métodos recursivos
		  metodosrecursivos operacoes = new metodosrecursivos();
		   ...
		   switch (opc) {
		     case 6:
		    	 System.out.println("É igual a " + operacoes.fatorial(exercicio06())+"!");
		    	 break;
		 	 case 7:
		 		System.out.println("Soma de todos os números: " + operacoes.somatotal(100));
		   		break;
		 	 case 8:
		 		System.out.println("Soma dos pares de 1 a 200: " + operacoes.somapares(200,0));
		   		break;
		 	 case 9:
		 		System.out.println("Soma dos ímpares de 1 a 300: " + operacoes.somaimpares(5,0));
		   		break;		
		    }
		  }
	    }
